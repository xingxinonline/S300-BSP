#ifndef APP_GIMBAL_MASTER_CARD1_SUBBOARD_H
#define APP_GIMBAL_MASTER_CARD1_SUBBOARD_H
...
typedef uint32_t (*app_card1_subboard_millis_fn_t)(void);
typedef int (*app_card1_subboard_read_reg8_fn_t)(uint8_t slave_addr, uint8_t reg, uint8_t *value);
typedef int (*app_card1_subboard_read_regs_fn_t)(uint8_t slave_addr, uint8_t reg, uint8_t *buffer, uint32_t length);
...
typedef void (*app_card1_subboard_overlay_draw_fn_t)(const subboard_detection_result_t *result);

typedef struct {
    app_card1_subboard_millis_fn_t millis_fn;
    app_card1_subboard_read_reg8_fn_t read_reg8_at;
    app_card1_subboard_read_regs_fn_t read_regs_at;
    ...
    app_card1_subboard_overlay_draw_fn_t overlay_draw;
} app_card1_subboard_ops_t;
