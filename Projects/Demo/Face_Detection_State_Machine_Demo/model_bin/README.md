# Face_Detection_State_Machine_Demo DSP Binary Files
...
1. 将 DSP bin 拷贝到本目录。
2. 运行 `ninja dbg_face_detection_state_machine_demo` 启动联调。
3. 或运行 `ninja img_s300_face_detection_state_machine_demo` 生成整包镜像。
