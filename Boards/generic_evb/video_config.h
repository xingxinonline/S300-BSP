...
#ifndef BINNING_SIZE
#define BINNING_SIZE            (1) // binning = 4 @ Sensor image size (1280*1920)
#endif
...
#define DISP_RALPHA1_ADDR           (0x80700000 - (DISP_IMAGE_WIDTH * DISP_IMAGE_HEIGHT * 1))
#endif

/* SRAM1 */
#ifndef DISP_RFRAME0_ADDR
#define DISP_RFRAME0_ADDR           (0x80700000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 3))
#endif
#ifndef DISP_RFRAME1_ADDR
#define DISP_RFRAME1_ADDR           (0x80700000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 5))
#endif
#ifndef DISP_WFRAME0_ADDR
#define DISP_WFRAME0_ADDR           (0x80700000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 7))
#endif
