/**
 * @file    board.h
 * @brief   Board Support Package for S300 Generic EVB
 * @details 板级配置头文件，定义硬件引脚、外设参数和初始化接口。
...
/* LCD Backlight: Pin=0xFF 表示无软件控制（直连 VCC） */
...
#define BOARD_CAM_RST_PIN           15
#endif

#ifndef BOARD_CAM_PWDN_PIN
#define BOARD_CAM_PWDN_PIN          6
#endif
