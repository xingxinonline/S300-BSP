...
#define FACE_DET_INPUT_WIDTH        (160)
#endif
#ifndef FACE_DET_INPUT_HEIGHT
#define FACE_DET_INPUT_HEIGHT       (128)
#endif

/** @brief 人形检测模型输入尺寸 */
#ifndef HUMAN_DET_INPUT_WIDTH
#define HUMAN_DET_INPUT_WIDTH       (160)
#endif
#ifndef HUMAN_DET_INPUT_HEIGHT
#define HUMAN_DET_INPUT_HEIGHT      (128)
#endif

/** @brief 手势检测模型输入尺寸 */
#ifndef GESTURE_DET_INPUT_WIDTH
#define GESTURE_DET_INPUT_WIDTH     (160)
#endif
...
/*
 * gimbal_node 复用主板的 MM/SPI 配置寄存器布局，
 * 但本板没有本地 LCD，不在 init_video() 阶段使能 LCD SPI 输出，也不拉背光。
 */
#ifndef BOARD_LCD_SPI_ENABLE_ON_INIT
#define BOARD_LCD_SPI_ENABLE_ON_INIT 0
#endif

#ifndef BOARD_LCD_BACKLIGHT_ENABLE_ON_INIT
#define BOARD_LCD_BACKLIGHT_ENABLE_ON_INIT 0
#endif
