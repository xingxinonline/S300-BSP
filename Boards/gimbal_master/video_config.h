...
#define DISP_RALPHA1_ADDR           (0x44040000 - (DISP_IMAGE_WIDTH * DISP_IMAGE_HEIGHT * 2))
#endif

/* SRAM1 */
#ifndef DISP_RFRAME0_ADDR
#define DISP_RFRAME0_ADDR           (0x44040000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 4))
#endif
#ifndef DISP_RFRAME1_ADDR
#define DISP_RFRAME1_ADDR           (0x44040000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 6))
#endif
#ifndef DISP_WFRAME0_ADDR
#define DISP_WFRAME0_ADDR           (0x44040000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 8))
#endif
#ifndef DISP_WFRAME1_ADDR
#define DISP_WFRAME1_ADDR           (0x44040000 - (SNAP_IMAGE_WIDTH * SNAP_IMAGE_HEIGHT * 10))
#endif
